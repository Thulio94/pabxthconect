...
<script>window.__SUPERVISION_CONFIG__ = {{ Illuminate\Support\Js::from(['uri' => 'sip:'.$credentials['sip_user'].'@'.$credentials['sip_host'], 'password' => $credentials['sip_pass'], 'domain' => $credentials['sip_host'], 'websocketUrl' => $credentials['sip_ws_uri'], 'agentsUrl' => route('admin.supervision.agents'), 'dailyUrl' => url('/administracao/acompanhamento/ramais'), 'startUrl' => url('/administracao/acompanhamento/ramais'), 'logoutUrl' => url('/administracao/acompanhamento/ramais'), 'finishUrl' => url('/administracao/acompanhamento/sessoes')]) }};</script>
@endsection
