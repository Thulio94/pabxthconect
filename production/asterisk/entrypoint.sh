...
docker_local_net="${PBX_DOCKER_LOCAL_NET:-172.16.0.0/12}"
...
sed -e "s|__PBX_PUBLIC_IP__|$public_ip|g" -e "s|__PBX_LOCAL_NET__|$local_net|g" -e "s|__PBX_DOCKER_LOCAL_NET__|$docker_local_net|g" \
